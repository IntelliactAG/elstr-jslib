YUI.add('elstr_managestale', function(Y) {

    // Copied from: 
    // http://yuilibrary.com/gallery/show/datasource-manage-stale 
    // https://github.com/ghinch/yui3-gallery/tree/master/build/gallery-datasource-manage-stale
    ...
    Y.namespace('ELSTR').ManageStale = Y.Base.create('elstr_managestale', Y.Plugin.Base, [], {
        _lastId: null,
        _transactions: null,
