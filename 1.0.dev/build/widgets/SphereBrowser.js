...
(function(){
    ...
    var Lang = YAHOO.lang, Event = YAHOO.util.Event, CustomEvent = YAHOO.util.CustomEvent, Dom = YAHOO.util.Dom, SphereBrowser = ELSTR.widget.SphereBrowser, UA = YAHOO.env.ua, bIEQuirks = (UA.ie && (UA.ie <= 6 || document.compatMode == "BackCompat")), m_oShadowTemplate,    /**
    ...
    YAHOO.extend(SphereBrowser, YAHOO.widget.Module, {
        ...
        /**
         * Creates a new Spherebrowser UI
        ...
        createNewGraph: function(el){
            ...
            var mgraph = new RGraph(canvas, {
                ...
                onCreateLabel: function(domElement, node){
                    ...
                    domElement.onclick = function(){
                        // fire the clickevent						
                        ELSTR.widget.SphereBrowser.instance.nodeClickEvent.fire({
                            node: node,
                            target: this
                        });
                    };
                    ...
                    domElement.ondblclick = function(){
                        ELSTR.widget.SphereBrowser.instance.rgraph.onClick(node.id, {
                            hideLabels: false
                        });
                        // fire the clickevent						
                        ELSTR.widget.SphereBrowser.instance.nodeDblClickEvent.fire({
                            node: node,
                            target: this
                        });
                    };
            ...
            mgraph.updateJson = function(json){
